...
public enum AppsmithError {
    ...
    REMOVE_LAST_WORKSPACE_ADMIN_ERROR(400, 4038, "The last administrator user cannot be removed from the workspace. Please make another user the administrator before leaving this workspace.", AppsmithErrorAction.DEFAULT, null, ErrorType.INTERNAL_ERROR, null),
